...
class EnhancedSportsPredictor:
    ...
    def prepare_features(self, df, is_training=False):
        ...
        exclude_cols = categorical_cols + ['match_id', 'start_time'] + [
    ...
    def predict_match(self, home_team, away_team, league):
        """Enhanced prediction with result-based learning"""
        if not self.models:
    ...
    def predict_with_enhanced_reasoning(self, home_team, away_team, league):
        ...
        print(f"\nPERFORMACE-BASED TEAM ANALYSIS:")
        print(f"  {home_team}:")
...
def main():
    """Enhanced main execution with result integration"""
    ...
    print("1. predict <home_team> <away_team> <league> - Enhanced prediction with performance analysis")
    print("2. evaluate - Evaluate predictions against actual results")
    print("3. update_results [folder] - Update with new results for continuous learning")
    print("4. retrain - Retrain models with all available data")
    print("5. performance - Show detailed performance report")
    print("6. team_analysis <team_name> - Show comprehensive team analysis")
    print("7. match_history <home_team> <away_team> - Show head-to-head history")
    print("8. league_patterns <league_name> - Analyze league-specific patterns")
    print("9. save - Save current models")
    print("10. quit")
    
    while True:
        try:
            command = input("\nEnter command: ").strip().split(maxsplit=3)
            ...
            if command[0] == 'quit':
                ...
                away_team = command[2]
                league = command[3]
                predictor.predict_with_enhanced_reasoning(home_team, away_team, league)
            ...
            elif command[0] == 'update_results':
                folder = command[1] if len(command) > 1 else None
            ...
            elif command[0] == 'team_analysis' and len(command) >= 2:
